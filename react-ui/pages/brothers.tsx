...
export default function BrothersPage() {
  ...
  return (
    <main className={styles.main}>
      {addModal && (
        <AddBrotherModalComponent
          onClose={() => onRefreshTable()}
        ></AddBrotherModalComponent>
      )}
      {editingBrother && (
        <EditBrotherModalComponent
          newBrother={editingBrother}
          onClose={() => onRefreshTable()}
        ></EditBrotherModalComponent>
      )}
      {graduatingBrother && (
        <GraduateBrotherModalComponent
          graduatingBrother={graduatingBrother}
          onClose={() => onRefreshTable()}
        ></GraduateBrotherModalComponent>
      )}
      <div
        className={
          addModal || editingBrother || graduatingBrother
            ? styles.unclickable
            : styles.full
        }
      >
